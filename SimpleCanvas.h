...
class SimpleCanvas {
    ...
    public:
        ...
        /**
         * @brief Construct a new image object from a pre-specified 2D array,
         *        assumed to be grayscale
         * 
         * @param d The image, specified as a 2D array
         * @param width Width of image
         * @param height Height of image
         */
        SimpleCanvas(uint8_t** d, int width, int height) {
            this->width = width;
            this->height = height;
...
/**
 * @brief Write a grayscale image to a file
 * 
 * @param filename Path to file
 * @param data 2D array to write to file
 * @param width Width of image
 * @param height Height of image
 */
void writeImage(char* filename, uint8_t** data, int width, int height) {
    SimpleCanvas image(data, width, height);
